...
namespace MediaPortal.ControlDevices.USBUIRT
{
  ...
  public class USBUIRTLearnForm : System.Windows.Forms.Form
  {
    ...
    public USBUIRTLearnForm(LearnType learnType)
    {
      ...
      USBUIRT.Instance.OnRemoteCommandFeedback += new USBUIRTAPI.RemoteCommandFeedbackHandler(Instance_OnRemoteCommandFeedback);
    ...
    protected override void OnLoad(EventArgs e)
    {
      ...
      Hashtable mpCommandsTable = USBUIRT.Instance.LearnedMediaPortalCodesTable;
      ...
      Hashtable stbTunerCodesTable = USBUIRT.Instance.LearnedSTBCodesTable;
    ...
    private void DoMediaPortalCommandLearn()
    {
      ...
      USBUIRT.Instance.OnEndLearning += new USBUIRTAPI.EndLearnedHandler(Instance_OnEndRxLearning);
      USBUIRT.Instance.BulkLearn(learncommands, learnbuttons);
    }
    ...
    private void LearnSingleMPCmdBtn_Click(object sender, System.EventArgs e)
    {
      ...
      if (USBUIRT.Instance.ClearLearnedCommand((Action.ActionType)commands[selIndex]))
      {
    ...
    {
      USBUIRT.Instance.StartLearning += new USBUIRTAPI.StartLearningEventHandler(Instance_StartTxLearning);
      USBUIRT.Instance.OnEventLearned += new USBUIRTAPI.EventLearnedHandler(Instance_OnTxEventLearned);
      USBUIRT.Instance.OnEndLearning += new USBUIRTAPI.EndLearnedHandler(Instance_OnTxEndLearning);
      ...
      if (cmdList.Count > 0)
      {
        ...
        USBUIRT.Instance.LearnTunerCodes(cmds);
      }
    }
    ...
    private void DoSingleSetTopBoxCommandLearn()
    {
      ...
      USBUIRT.Instance.StartLearning += new USBUIRTAPI.StartLearningEventHandler(Instance_StartTxLearning);
      USBUIRT.Instance.OnEventLearned += new USBUIRTAPI.EventLearnedHandler(Instance_OnTxEventLearned);
      USBUIRT.Instance.OnEndLearning += new USBUIRTAPI.EndLearnedHandler(Instance_OnTxEndSingleCommandLearning);
    ...
    {
      if (USBUIRT.Instance.LearnedSTBCodesTable.Count == 0)
      {
      ...
      {
        if (USBUIRT.Instance.ClearAllLearnedSTBCommands())
        {
    ...
    private void ClearSingleLearnedSTBCmdBtn_Click(object sender, EventArgs e)
    {
      ...
      if (selIndex != -1)
      {
        if (USBUIRT.Instance.ClearLearnedSTBCommand(selIndex))
        {
    ...
    private void StbCommandsChkLst_SelectedIndexChanged(object sender, EventArgs e)
    {
      ...
      if (selIndex != -1)
      {
        ...
        if (USBUIRT.Instance.GetSTBCommandIrStrings(selIndex, ref irCmd1, ref irCmd2))
        {
    ...
    private void ActionsCheckList_SelectedIndexChanged(object sender, System.EventArgs e)
    {
      ...
      if (selIndex != -1)
      {
        ...
        if (USBUIRT.Instance.GetCommandIrStrings((Action.ActionType)commands[selIndex], ref irCmd1, ref irCmd2))
        {
    ...
    private void Instance_StartTxLearning(object sender, LearningEventArgs e)
    {
    ...
    private void Instance_OnTxEventLearned(object sender, LearningEventArgs e)
    {
    ...
    private void SetEndTxEndLearningStatus(EventArgs e)
    {
      ...
      else
      {
        ...
        else if (USBUIRT.Instance.SaveTunerValues())
        {
          LearnPrgBar.Value = LearnPrgBar.Maximum;
    ...
    {
      USBUIRT.Instance.AbortLearn = true;
    }
    #endregion
