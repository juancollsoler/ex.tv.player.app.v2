namespace MpeMaker.Sections
{
    partial class ToolsUpdateXml
    {
      ...
      this.toolTip1.SetToolTip(this.textBox1, "A relative path (like .\\update.xml) is allowed.");
      ...
      this.toolTip1.SetToolTip(this.btn_gen, "If the file exists, it will be updated not overwritten.");
      ...
      this.groupBox2.Text = "Add another list to a list";
      // 
      // btn_browse2
      // 
      ...
      this.toolTip1.SetToolTip(this.btn_publish, "Publishing is only required once per extension, not for a new version!");
