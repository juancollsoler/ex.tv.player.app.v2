  ...
  public class TreeView : System.Windows.Forms.TreeView
  {
    ...
    private void SetFocusToNode(TreeNode tn, bool visible)
    {
      ...
      else
      {
        if (tn.BackColor != SelectionBackColor)
        {
          g.DrawRectangle(new Pen(new SolidBrush(BackColor), 1), tnMostRecentSelectedNode.Bounds.X,
                          tnMostRecentSelectedNode.Bounds.Y, tnMostRecentSelectedNode.Bounds.Width,
    ...
    protected override void OnMouseUp(MouseEventArgs e)
    {
      ...
      try
      {
        ...
        if (!this.blnNodeProcessedOnMouseDown)
        {
          ...
          {
            this.ProcessNodeRange(this.tnMostRecentSelectedNode, tn, e, Control.ModifierKeys, TreeViewAction.ByMouse,
                                  true);
          }
        }
    ...
    private void ProcessNodeRange(TreeNode startNode, TreeNode endNode, MouseEventArgs e, Keys keys, TreeViewAction tva,
                                  bool allowStartEdit)
    {
    ...
    protected override void OnKeyDown(KeyEventArgs e)
    {
      ...
      if ((tnNewlySelectedNodeWithKeys != null))
      {
        ...
        ProcessNodeRange(tnKeysStartNode, tnNewlySelectedNodeWithKeys,
