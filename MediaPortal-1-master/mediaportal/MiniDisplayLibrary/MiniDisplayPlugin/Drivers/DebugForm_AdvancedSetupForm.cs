...
{
  public class DebugForm_AdvancedSetupForm : MPConfigForm
  {
    ...
    public DebugForm_AdvancedSetupForm()
    {
      ...
      this.cmbEQTitleDisplayTime.DataBindings.Add("SelectedIndex", DebugForm.AdvancedSettings.Instance,
                                                  "EQTitleDisplayTime");
      ...
      this.mpBlankDisplayWithVideo.DataBindings.Add("Checked", DebugForm.AdvancedSettings.Instance,
      ...
      this.mpEnableDisplayActionTime.DataBindings.Add("SelectedIndex", DebugForm.AdvancedSettings.Instance,
                                                      "EnableDisplayActionTime");
      this.mpBlankDisplayWhenIdle.DataBindings.Add("Checked", DebugForm.AdvancedSettings.Instance,
