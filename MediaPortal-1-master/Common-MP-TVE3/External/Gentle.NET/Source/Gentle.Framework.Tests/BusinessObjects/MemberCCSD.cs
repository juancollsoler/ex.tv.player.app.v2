 ...
 *
 * $Id: MemberCCSD.cs 1232 2008-03-14 05:36:00Z mm $
 */
...
namespace Gentle.Framework.Tests
{
	...
	public class MemberCCSD : Member
	{
		...
		public MemberCCSD( int listId, string name, string address ) :
			this( 1, 0, listId, name, address )
		{
		}

		// construct new list instance (existing database record)
		public MemberCCSD( int databaseVersion, int id, int listId, string name, string address ) :
		...
		{
			get { return Broker.RetrieveList( typeof(MemberCCSD) ); }
		}
	}
}