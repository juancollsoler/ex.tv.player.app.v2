...
interface IMPAudioSwitcherFilter: public IUnknown
{
	STDMETHOD (GetAudioDualMonoMode)(ULONG* mode)=0;
	STDMETHOD (SetAudioDualMonoMode)(ULONG mode)=0;
};
...
class CAudioSwitcherFilter : public CStreamSwitcherFilter, public IAudioSwitcherFilter, public IMPAudioSwitcherFilter
{
...
public:
	...
	STDMETHODIMP GetAudioDualMonoMode(ULONG* mode);
	STDMETHODIMP SetAudioDualMonoMode(ULONG mode);
